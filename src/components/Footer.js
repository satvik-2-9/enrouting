    ...
    <div className="Footer">
      <div className="links-section">
        <div className="links-vertical-div">
          ...
          <p className="links-text">About us</p>
        ...
        <div className="links-vertical-div">
          ...
          <p className="links-title">EVENTS</p>
          <p className="links-title">FAQ</p>
        </div>
        <div className="links-vertical-div">
          <p className="links-title">SOCIAL MEDIA</p>
          <div className="social-media-icons-container">
            <img src={linkedinIcon} alt="linkedin-icon" className="social-media-icon" />
            <img src={fbIcon} alt="fb-icon" className="social-media-icon" />
            <img src={instaIcon} alt="insta-icon" className="social-media-icon" />
            <img src={youtubeIcon} alt="youtube-icon" className="social-media-icon" />
          </div>
        </div>
      </div>
      ...
      <footer className="footer-text">© 2021 Enrouting careers. All rights reserved.</footer>
    </div>
  );
};
